                        ...
                        .map(action => (
                          <DropdownMenuItem
                            ...
                            onClick={() => {
                              ...
                              if (window.confirm(`Execute ${action.label || action.name}?`)) {
                              ...
                              {relations.map(relation => (
                                <DropdownMenuItem
                                  ...
                                  onClick={() => {
                                    ...
                                    console.log(`View relation: ${relation.subject} -> ${relation.relation} -> ${relation.object}`);
                                    console.log(`Item ID: ${item.reference_id || item.id}`);
                                  }}
                                >
                                  {relation.object}
                                </DropdownMenuItem>

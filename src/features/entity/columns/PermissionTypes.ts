...
export const PermissionPresets = {
  None: 0,
  ReadOnly:
    PermissionFlag.GuestRead |
    PermissionFlag.UserRead |
    PermissionFlag.GroupRead,
  GuestCRUD:
    PermissionFlag.GuestPeek |
    PermissionFlag.GuestRead |
    PermissionFlag.GuestCreate |
    PermissionFlag.GuestUpdate |
    PermissionFlag.GuestDelete |
    PermissionFlag.GuestRefer,
  UserCRUD:
    PermissionFlag.UserPeek |
    PermissionFlag.UserRead |
    PermissionFlag.UserCreate |
    PermissionFlag.UserUpdate |
    PermissionFlag.UserDelete |
    PermissionFlag.UserRefer,
  GroupCRUD:
    PermissionFlag.GroupPeek |
    PermissionFlag.GroupRead |
    PermissionFlag.GroupCreate |
    PermissionFlag.GroupUpdate |
    PermissionFlag.GroupDelete |
    PermissionFlag.GroupRefer,

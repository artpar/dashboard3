...
export function EntityDetailField({
  ...
  const isExpandable = enableExpansion && (
    typeof value === 'object' ||
          ...
          <div className="ml-auto flex items-start gap-1">
            {value !== null && value !== undefined && (
              <Button
                variant="ghost"
                size="sm"
                className="h-7 w-7 rounded-full p-0 opacity-0 transition-opacity hover:bg-muted-foreground/10 group-hover:opacity-100 hover:opacity-100"
            ...
            {isExpandable && (
              <Button
                variant="ghost"
                size="sm"
                className="hidden h-7 w-7 rounded-full p-0 opacity-0 transition-opacity hover:bg-muted-foreground/10 group-hover:opacity-100 hover:opacity-100 sm:flex"
                onClick={onToggleExpand}
              >
                <ChevronRightIcon
                  className={cn(
